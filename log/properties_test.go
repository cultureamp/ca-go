...
func ExampleLog_Debug() {
	...
	// Output:
	// 2020-11-14T11:30:32Z DBG event="logging should contain all types: ok" app= app_version=1.0.0 aws_account_id=development aws_region= event=debug_with_all_field_types farm=local product= properties={"bool":true,"bytes":"some bytes","dur":42000,"func":"val","int":1,"int64":123,"ipaddr":"255.255.255.255","str":"value","time":"2023-11-14T11:30:32Z","uint":234,"uint64":123,"uuid":"e5fa7acf-1846-41b4-a2ee-80ecd86fb060"}
}
